...
func New(baseURL, token string) *Client {
	return &Client{baseURL: normalizeBaseURL(baseURL), token: token, cli: &fasthttp.Client{}}
}
...
func (c *Client) ClipzyZaiXianJianTieBan() *ClipzyZaiXianJianTieBanApi {
	return &ClipzyZaiXianJianTieBanApi{c: c}
}
...
func (api *ClipzyZaiXianJianTieBanApi) GetClipzyRaw(args map[string]any) (any, error) {
	...
	if v, ok := args["id"]; ok {
		path = strings.ReplaceAll(path, "{"+"id"+"}", fmt.Sprint(v))
	}
	return api.c.do("GET", path, q, nil)
}
...
func (api *ClipzyZaiXianJianTieBanApi) PostClipzyStore(args map[string]any) (any, error) {
	...
	if v, ok := args["compressedData"]; ok {
		body["compressedData"] = v
	}
	if v, ok := args["ttl"]; ok {
		body["ttl"] = v
	}
...
func (api *GameApi) GetGameMinecraftServerstatus(args map[string]any) (any, error) {
	q := map[string]string{}
	if v, ok := args["server"]; ok {
		q["server"] = fmt.Sprint(v)
	}
...
func (api *GameApi) GetGameSteamSummary(args map[string]any) (any, error) {
	q := map[string]string{}
	if v, ok := args["steamid"]; ok {
		q["steamid"] = fmt.Sprint(v)
	}
	if v, ok := args["id"]; ok {
		q["id"] = fmt.Sprint(v)
	}
...
func (api *ImageApi) GetImageMotou(args map[string]any) (any, error) {
	...
	if v, ok := args["bg_color"]; ok {
		q["bg_color"] = fmt.Sprint(v)
	}
...
func (api *ImageApi) GetImageQrcode(args map[string]any) (any, error) {
	...
	if v, ok := args["format"]; ok {
		q["format"] = fmt.Sprint(v)
	}
	if v, ok := args["transparent"]; ok {
		q["transparent"] = fmt.Sprint(v)
	}
	if v, ok := args["fgcolor"]; ok {
		q["fgcolor"] = fmt.Sprint(v)
	}
	if v, ok := args["bgcolor"]; ok {
		q["bgcolor"] = fmt.Sprint(v)
	}
...
func (api *ImageApi) PostImageSpeechless(args map[string]any) (any, error) {
	...
	body := make(map[string]any)
	if v, ok := args["bottom_text"]; ok {
		body["bottom_text"] = v
	}
	if v, ok := args["top_text"]; ok {
		body["top_text"] = v
	}
	if len(body) == 0 {
		return api.c.do("POST", path, q, nil)
...
func (api *ImageApi) PostImageSvg(args map[string]any) (any, error) {
	...
	if v, ok := args["width"]; ok {
		q["width"] = fmt.Sprint(v)
	}
	if v, ok := args["height"]; ok {
		q["height"] = fmt.Sprint(v)
	}
	if v, ok := args["quality"]; ok {
		q["quality"] = fmt.Sprint(v)
	}
...
func (api *MiscApi) GetMiscDistrict(args map[string]any) (any, error) {
	...
	if v, ok := args["keywords"]; ok {
		q["keywords"] = fmt.Sprint(v)
	}
	if v, ok := args["adcode"]; ok {
		q["adcode"] = fmt.Sprint(v)
	}
	if v, ok := args["lat"]; ok {
		q["lat"] = fmt.Sprint(v)
	}
...
func (api *MiscApi) GetMiscHolidayCalendar(args map[string]any) (any, error) {
	...
	if v, ok := args["timezone"]; ok {
		q["timezone"] = fmt.Sprint(v)
	}
	if v, ok := args["holiday_type"]; ok {
		q["holiday_type"] = fmt.Sprint(v)
	}
	if v, ok := args["include_nearby"]; ok {
		q["include_nearby"] = fmt.Sprint(v)
	}
	if v, ok := args["nearby_limit"]; ok {
		q["nearby_limit"] = fmt.Sprint(v)
	}
...
func (api *MiscApi) GetMiscHotboard(args map[string]any) (any, error) {
	...
	if v, ok := args["keyword"]; ok {
		q["keyword"] = fmt.Sprint(v)
	}
	if v, ok := args["time_start"]; ok {
		q["time_start"] = fmt.Sprint(v)
	}
	if v, ok := args["time_end"]; ok {
		q["time_end"] = fmt.Sprint(v)
	}
	if v, ok := args["limit"]; ok {
		q["limit"] = fmt.Sprint(v)
	}
	if v, ok := args["sources"]; ok {
		q["sources"] = fmt.Sprint(v)
	}
...
func (api *MiscApi) GetMiscRandomnumber(args map[string]any) (any, error) {
	...
	if v, ok := args["count"]; ok {
		q["count"] = fmt.Sprint(v)
	}
	if v, ok := args["allow_repeat"]; ok {
		q["allow_repeat"] = fmt.Sprint(v)
	}
	if v, ok := args["allow_decimal"]; ok {
		q["allow_decimal"] = fmt.Sprint(v)
	}
	if v, ok := args["decimal_places"]; ok {
		q["decimal_places"] = fmt.Sprint(v)
	}
...
func (api *MiscApi) GetMiscTrackingDetect(args map[string]any) (any, error) {
	q := map[string]string{}
	if v, ok := args["tracking_number"]; ok {
		q["tracking_number"] = fmt.Sprint(v)
	}
...
func (api *MiscApi) GetMiscTrackingQuery(args map[string]any) (any, error) {
	...
	if v, ok := args["carrier_code"]; ok {
		q["carrier_code"] = fmt.Sprint(v)
	}
	if v, ok := args["phone"]; ok {
		q["phone"] = fmt.Sprint(v)
	}
...
func (api *MiscApi) GetMiscWeather(args map[string]any) (any, error) {
	...
	if v, ok := args["extended"]; ok {
		q["extended"] = fmt.Sprint(v)
	}
	if v, ok := args["forecast"]; ok {
		q["forecast"] = fmt.Sprint(v)
	}
	if v, ok := args["hourly"]; ok {
		q["hourly"] = fmt.Sprint(v)
	}
	if v, ok := args["minutely"]; ok {
		q["minutely"] = fmt.Sprint(v)
	}
	if v, ok := args["indices"]; ok {
		q["indices"] = fmt.Sprint(v)
	}
...
func (api *SocialApi) GetSocialBilibiliArchives(args map[string]any) (any, error) {
	...
	if v, ok := args["orderby"]; ok {
		q["orderby"] = fmt.Sprint(v)
	}
	if v, ok := args["ps"]; ok {
		q["ps"] = fmt.Sprint(v)
	}
...
func (api *TranslateApi) PostAiTranslate(args map[string]any) (any, error) {
	...
	if v, ok := args["preserve_format"]; ok {
		body["preserve_format"] = v
	}
	if v, ok := args["source_lang"]; ok {
		body["source_lang"] = v
	}
...
func (api *TranslateApi) PostTranslateStream(args map[string]any) (any, error) {
	...
	body := make(map[string]any)
	if v, ok := args["from_lang"]; ok {
		body["from_lang"] = v
	}
	if v, ok := args["query"]; ok {
		body["query"] = v
	}
	if v, ok := args["to_lang"]; ok {
		body["to_lang"] = v
	}
	if v, ok := args["tone"]; ok {
		body["tone"] = v
	}
	if len(body) == 0 {
		return api.c.do("POST", path, q, nil)
...
func (api *WebparseApi) GetWebTomarkdownAsyncStatus(args map[string]any) (any, error) {
	...
	if v, ok := args["task_id"]; ok {
		path = strings.ReplaceAll(path, "{"+"task_id"+"}", fmt.Sprint(v))
	}
	return api.c.do("GET", path, q, nil)
}
...
func (api *ZhiNengSouSuoApi) PostSearchAggregate(args map[string]any) (any, error) {
	...
	body := make(map[string]any)
	if v, ok := args["fetch_full"]; ok {
		body["fetch_full"] = v
	}
	if v, ok := args["filetype"]; ok {
		body["filetype"] = v
	}
	if v, ok := args["query"]; ok {
		body["query"] = v
	}
	if v, ok := args["site"]; ok {
		body["site"] = v
	}
	if v, ok := args["sort"]; ok {
		body["sort"] = v
	}
	if v, ok := args["time_range"]; ok {
		body["time_range"] = v
	}
