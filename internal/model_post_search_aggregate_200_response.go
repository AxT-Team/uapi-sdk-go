...
type PostSearchAggregate200Response struct {
	Metadata *PostSearchAggregate200ResponseMetadata `json:"metadata,omitempty"`
	// 本次请求总耗时（毫秒）
...
func (o *PostSearchAggregate200Response) GetMetadata() PostSearchAggregate200ResponseMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret PostSearchAggregate200ResponseMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given PostSearchAggregate200ResponseMetadata and assigns it to the Metadata field.
