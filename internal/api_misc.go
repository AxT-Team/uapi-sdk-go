...
func (a *MiscAPIService) GetHistoryProgrammerExecute(r ApiGetHistoryProgrammerRequest) (*GetHistoryProgrammer200Response, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 500 {
			var v GetHistoryProgrammer500Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r ApiGetMiscHolidayCalendarRequest) ExcludePast(excludePast bool) ApiGetMiscHolidayCalendarRequest {
	r.excludePast = &excludePast
	return r
}
...
func (a *MiscAPIService) GetMiscHolidayCalendarExecute(r ApiGetMiscHolidayCalendarRequest) (*GetMiscHolidayCalendar200Response, *http.Response, error) {
	...
	if r.excludePast != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "exclude_past", r.excludePast, "form", "")
	} else {
        var defaultValue bool = false
        parameterAddToHeaderOrQuery(localVarQueryParams, "exclude_past", defaultValue, "form", "")
        r.excludePast = &defaultValue
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiGetMiscMovieBoxOfficeRequest struct {
	ctx context.Context
	ApiService *MiscAPIService
}

func (r ApiGetMiscMovieBoxOfficeRequest) Execute() (*GetMiscMovieBoxOffice200Response, *http.Response, error) {
	return r.ApiService.GetMiscMovieBoxOfficeExecute(r)
}

/*
GetMiscMovieBoxOffice 查询电影票房
...
调用此接口，无需任何参数，即可获取当前实时的电影市场大盘数据（包含总票房、总场次、总人次），以及每一部上映影片的具体表现（包括票房明细、排片占比、上座率、场均人次和累计票房等）。
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetMiscMovieBoxOfficeRequest
*/
func (a *MiscAPIService) GetMiscMovieBoxOffice(ctx context.Context) ApiGetMiscMovieBoxOfficeRequest {
	return ApiGetMiscMovieBoxOfficeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MiscAPIService) GetMiscMovieBoxOfficeExecute(r ApiGetMiscMovieBoxOfficeRequest) (*GetMiscMovieBoxOffice200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetMiscMovieBoxOffice200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MiscAPIService.GetMiscMovieBoxOffice")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/misc/movie-box-office"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 503 {
			var v GetMiscMovieBoxOffice503Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
type ApiGetMiscMovieRatingRankRequest struct {
	ctx context.Context
	ApiService *MiscAPIService
	channel *string
	platform *string
...
func (r ApiGetMiscMovieRatingRankRequest) Channel(channel string) ApiGetMiscMovieRatingRankRequest {
	r.channel = &channel
	return r
}

// 按渠道或平台关键字过滤，例如 卫视、爱奇艺。
func (r ApiGetMiscMovieRatingRankRequest) Platform(platform string) ApiGetMiscMovieRatingRankRequest {
	r.platform = &platform
	return r
}

// 每个渠道仅返回前 N 条。
func (r ApiGetMiscMovieRatingRankRequest) Limit(limit int32) ApiGetMiscMovieRatingRankRequest {
	r.limit = &limit
	return r
}

// 排行周期：realtime、day、week、month，默认 realtime。
func (r ApiGetMiscMovieRatingRankRequest) Period(period string) ApiGetMiscMovieRatingRankRequest {
	r.period = &period
	return r
}

// 历史快照日期，格式 YYYY-MM-DD；用于 day/week/month。
func (r ApiGetMiscMovieRatingRankRequest) Date(date string) ApiGetMiscMovieRatingRankRequest {
	r.date = &date
	return r
}

func (r ApiGetMiscMovieRatingRankRequest) Execute() (*GetMiscMovieRatingRank200Response, *http.Response, error) {
	return r.ApiService.GetMiscMovieRatingRankExecute(r)
}

/*
GetMiscMovieRatingRank 电影收视排行查询
...
用 `channel` 切换全网、卫视、网络平台或院线榜单，用 `period` + `date` 查询历史日榜、周榜和月榜。适合影视资讯页、数据看板、自媒体选题和内容运营分析。
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetMiscMovieRatingRankRequest
*/
func (a *MiscAPIService) GetMiscMovieRatingRank(ctx context.Context) ApiGetMiscMovieRatingRankRequest {
	return ApiGetMiscMovieRatingRankRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MiscAPIService) GetMiscMovieRatingRankExecute(r ApiGetMiscMovieRatingRankRequest) (*GetMiscMovieRatingRank200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetMiscMovieRatingRank200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MiscAPIService.GetMiscMovieRatingRank")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/misc/movie-rating-rank"
	...
	if r.channel != nil {
        ...
        var defaultValue string = "all"
        parameterAddToHeaderOrQuery(localVarQueryParams, "channel", defaultValue, "form", "")
	...
	if r.period != nil {
        ...
        var defaultValue string = "realtime"
...
type ApiGetMiscWeatherHistoryRequest struct {
	ctx context.Context
	ApiService *MiscAPIService
	city *string
	adcode *string
...
func (r ApiGetMiscWeatherHistoryRequest) City(city string) ApiGetMiscWeatherHistoryRequest {
	r.city = &city
	return r
}

// 6 位行政区划代码，优先级高于 city。
func (r ApiGetMiscWeatherHistoryRequest) Adcode(adcode string) ApiGetMiscWeatherHistoryRequest {
	r.adcode = &adcode
	return r
}

// 起始日期，格式 YYYY-MM-DD；与 end_date 搭配使用。
func (r ApiGetMiscWeatherHistoryRequest) StartDate(startDate string) ApiGetMiscWeatherHistoryRequest {
	r.startDate = &startDate
	return r
}

// 结束日期，格式 YYYY-MM-DD，默认昨天。
func (r ApiGetMiscWeatherHistoryRequest) EndDate(endDate string) ApiGetMiscWeatherHistoryRequest {
	r.endDate = &endDate
	return r
}

// 回看天数，1-366，默认 365；仅在未指定 start_date 时生效。
func (r ApiGetMiscWeatherHistoryRequest) Days(days int32) ApiGetMiscWeatherHistoryRequest {
	r.days = &days
	return r
}

// 返回语言：zh（默认）或 en。
func (r ApiGetMiscWeatherHistoryRequest) Lang(lang string) ApiGetMiscWeatherHistoryRequest {
	r.lang = &lang
	return r
}

func (r ApiGetMiscWeatherHistoryRequest) Execute() (*GetMiscWeatherHistory200Response, *http.Response, error) {
	return r.ApiService.GetMiscWeatherHistoryExecute(r)
}

/*
GetMiscWeatherHistory 查询历史天气
...
> 定位优先级：`adcode` > `city` > IP 自动定位。同时传 `start_date` 和 `days` 时，以 `start_date` + `end_date` 区间为准。
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetMiscWeatherHistoryRequest
*/
func (a *MiscAPIService) GetMiscWeatherHistory(ctx context.Context) ApiGetMiscWeatherHistoryRequest {
	return ApiGetMiscWeatherHistoryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MiscAPIService) GetMiscWeatherHistoryExecute(r ApiGetMiscWeatherHistoryRequest) (*GetMiscWeatherHistory200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetMiscWeatherHistory200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MiscAPIService.GetMiscWeatherHistory")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/misc/weather/history"
