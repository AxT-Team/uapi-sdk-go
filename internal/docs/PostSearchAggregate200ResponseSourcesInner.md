...
### NewPostSearchAggregate200ResponseSourcesInner
...
### NewPostSearchAggregate200ResponseSourcesInnerWithDefaults
...
GetFirstResultHost returns the FirstResultHost field if non-nil, zero value otherwise.

### GetFirstResultHostOk

`func (o *PostSearchAggregate200ResponseSourcesInner) GetFirstResultHostOk() (*string, bool)`

GetFirstResultHostOk returns a tuple with the FirstResultHost field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetFirstResultHost sets FirstResultHost field to given value.
