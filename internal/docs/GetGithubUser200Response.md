...
**PinnedRepositories** | Pointer to [**[]GetGithubUser200ResponsePinnedRepositoriesInner**](GetGithubUser200ResponsePinnedRepositoriesInner.md) | 用户主页展示的 pinned 仓库列表（需开启 pinned&#x3D;true）。 | [optional] 
**PublicGists** | Pointer to **int32** | 公开 Gist 数量。 | [optional] 
**PublicRepos** | Pointer to **int32** | 公开仓库数量。 | [optional] 
**Repositories** | Pointer to [**[]GetGithubUser200ResponseRepositoriesInner**](GetGithubUser200ResponseRepositoriesInner.md) | 最近活跃的公开仓库列表（需开启 repos&#x3D;true 或传入 repos_limit）。 | [optional] 
...
GetPinnedRepositories returns the PinnedRepositories field if non-nil, zero value otherwise.

### GetPinnedRepositoriesOk

`func (o *GetGithubUser200Response) GetPinnedRepositoriesOk() (*[]GetGithubUser200ResponsePinnedRepositoriesInner, bool)`

GetPinnedRepositoriesOk returns a tuple with the PinnedRepositories field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetPinnedRepositories sets PinnedRepositories field to given value.

### HasPinnedRepositories
