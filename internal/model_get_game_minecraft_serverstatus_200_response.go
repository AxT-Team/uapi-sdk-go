...
type GetGameMinecraftServerstatus200Response struct {
	...
	OnlinePlayers []GetGameMinecraftServerstatus200ResponseOnlinePlayersInner `json:"online_players,omitempty"`
	// 当前在线的玩家数量。
...
func (o *GetGameMinecraftServerstatus200Response) GetOnlinePlayers() []GetGameMinecraftServerstatus200ResponseOnlinePlayersInner {
	if o == nil || IsNil(o.OnlinePlayers) {
		var ret []GetGameMinecraftServerstatus200ResponseOnlinePlayersInner
		return ret
	}
...
// SetOnlinePlayers gets a reference to the given []GetGameMinecraftServerstatus200ResponseOnlinePlayersInner and assigns it to the OnlinePlayers field.
