...
type GetMiscWeather200Response struct {
	...
	// 官方气象预警列表（存在有效预警时返回）
	Alerts []GetMiscWeather200ResponseAlertsInner `json:"alerts,omitempty"`
...
func (o *GetMiscWeather200Response) GetAlerts() []GetMiscWeather200ResponseAlertsInner {
	if o == nil || IsNil(o.Alerts) {
		var ret []GetMiscWeather200ResponseAlertsInner
		return ret
	}
	return o.Alerts
}
...
// SetAlerts gets a reference to the given []GetMiscWeather200ResponseAlertsInner and assigns it to the Alerts field.
