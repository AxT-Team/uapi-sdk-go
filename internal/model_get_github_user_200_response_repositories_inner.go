...
// checks if the GetGithubUser200ResponseRepositoriesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGithubUser200ResponseRepositoriesInner{}

// GetGithubUser200ResponseRepositoriesInner struct for GetGithubUser200ResponseRepositoriesInner
type GetGithubUser200ResponseRepositoriesInner struct {
	// 该仓库是否已归档。
...
func NewGetGithubUser200ResponseRepositoriesInner() *GetGithubUser200ResponseRepositoriesInner {
	this := GetGithubUser200ResponseRepositoriesInner{}
	return &this
}
...
func (o GetGithubUser200ResponseRepositoriesInner) MarshalJSON() ([]byte, error) {
...
func (o GetGithubUser200ResponseRepositoriesInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetGithubUser200ResponseRepositoriesInner struct {
	value *GetGithubUser200ResponseRepositoriesInner
	isSet bool
}

func (v NullableGetGithubUser200ResponseRepositoriesInner) Get() *GetGithubUser200ResponseRepositoriesInner {
	return v.value
}

func (v *NullableGetGithubUser200ResponseRepositoriesInner) Set(val *GetGithubUser200ResponseRepositoriesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGithubUser200ResponseRepositoriesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGithubUser200ResponseRepositoriesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGithubUser200ResponseRepositoriesInner(val *GetGithubUser200ResponseRepositoriesInner) *NullableGetGithubUser200ResponseRepositoriesInner {
	return &NullableGetGithubUser200ResponseRepositoriesInner{value: val, isSet: true}
}

func (v NullableGetGithubUser200ResponseRepositoriesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGithubUser200ResponseRepositoriesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
